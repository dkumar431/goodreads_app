...
ActiveRecord::Schema.define(version: 20161015153111) do
  ...
  create_table "subscriptions", force: :cascade do |t|
    ...
    t.datetime "created_at",                      null: false
    t.datetime "updated_at",                      null: false
    t.integer  "subscription_types_id", limit: 4
  end

  add_index "subscriptions", ["book_id"], name: "index_subscriptions_on_book_id", using: :btree
  add_index "subscriptions", ["subscription_types_id"], name: "index_subscriptions_on_subscription_types_id", using: :btree
